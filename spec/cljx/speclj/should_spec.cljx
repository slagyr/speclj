...
;    ;cljs-ignore->
;    #+clj (should-fail! (should-be-same 1 1.0))
;    ;<-cljs-ignore
;    )
;
...
;    ;cljs-ignore->
;    #+clj (should-pass! (should-not-be-same 1 1.0))
;    ;<-cljs-ignore
;    )
;
...
;    ;cljs-ignore->
;    #+clj (should-pass! (should-throw java.lang.Object (throw (java.lang.Exception.))))
;    ;<-cljs-ignore
...
;    ;cljs-ignore->
;    #+clj (should-fail! (should-throw exception "My message" (throw (java.lang.Throwable. "My message"))))
;    ;<-cljs-ignore
