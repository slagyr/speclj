...
(defmacro should-have-parse-error [arg-spec message & args]
  `(let [result# (sut/parse ~arg-spec [~@args])
...
(defmacro test-arguments [constructor]
  `(let [constructor# ~constructor]
     (context "Argument Parsing"
       ...
       (it "option names are required"
         (let [spec# (constructor#)]
           (should-throw RuntimeException "Options require a shortName and fullName"
